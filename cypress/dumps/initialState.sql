...
/*ALTER TABLE "public"."teams" ADD FOREIGN KEY ("object_id") REFERENCES "public"."manuscripts"("id") ON DELETE CASCADE;*/
ALTER TABLE "public"."threaded_discussions" ADD CONSTRAINT threaded_discussions_object_id_fkey FOREIGN KEY ("manuscript_id") REFERENCES "public"."manuscripts"("id") ON DELETE CASCADE;
